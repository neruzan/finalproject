...
function LandingPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      localStorage.setItem("finalproject-user", JSON.stringify(result.data));
      navigate("/home");
  ...
  useEffect(() => {
    if (localStorage.getItem("finalproject-user")) navigate("/home");
  });
  return (
    <div className="h-screen flex items-center sm:flex-col ">
      ...
      >
        <h1>
          <b className="text-[#2B8F74] text-8xl">LES</b>
          <b className="text-8xl text-gray-700"> NOTES</b>
        </h1>
        <p className="text-lg">
      ...
      <div className="w-1/2 sm:w-screen ">
        {!showLoginForm && !showRegisterForm && (
          ...
          // ></lottie-player>
          // <lottie-player
          //   src="https://assets4.lottiefiles.com/packages/lf20_p7ml1rhe.json"
          //   background="transparent"
          //   speed="1"
          //   loop
          //   autoplay
          // ></lottie-player>
          <lottie-player
            src="https://assets10.lottiefiles.com/packages/lf20_ljx86sv6.json"
            background="transparent"
            speed="1"
            loop
            autoplay
        ...
        {showLoginForm && (
          <div className="ml-40 sm:ml-0">
            <div className="flex flex-col bg-primary h-screen justify-center items-center px-20 space-y-5 ">
              <h1 className="text-6xl text-gray-500 text-lef w-full font-semibold my-5">
                LOGIN
              </h1>
      ...
      {(showLoginForm || showRegisterForm) && (
        <AiOutlineClose
          className="absolute top-5 right-5 z-10 cursor-pointer hover:bg-gray-100 hover:rounded-full hover:p-2  hover:text-white-50"
          size={30}
          color="gray"
          onClick={() => {
            setShowLoginForm(false);
